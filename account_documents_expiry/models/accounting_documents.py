...
class AccountingDocument(models.Model):
    ...
    employee_ref = fields.Many2one('hr.employee', string='Notified Employee',copy=False , required=True)
...
#
#     doc_attach_rel = fields.Many2many('accounting.document', 'doc_attachment_id', 'attach_id3', 'doc_id',
